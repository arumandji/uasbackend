...
const docTemplate = `{
    ...
    "paths": {
        "/v1/achievements": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Tingkat Achievement",
                        "name": "tingkat",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Keterangan / Alasan Reject",
                        "name": "keterangan",
                        "in": "formData"
                    }
                ],
        ...
        "/v1/mahasiswa/advisor/{dosen_wali_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        "models.Achievement": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "submitted / verified / rejected",
                    "type": "string"
                },
                "tahun": {
                    "type": "integer"
